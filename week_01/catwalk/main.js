...
let img1 = document.getElementsByClassName('cat1');
img1.style.top = '60px';
img1.style.left = '0px';
...
let img6 = document.getElementsByClassName('cat6')[0];
img6.style.top = '580px';
img6.style.left = '400px';

const catwalk6 = function(){
    let currentLeft = parseInt(img6.style.left);
    let currentTop = parseInt(img6.style.top);
    img6.style.left = (currentLeft - 2) + 'px';
    img6.style.top = (currentTop - 3) + 'px';
    if(currentTop == 0){
        img6.style.left = '400px';
        img6.style.top = '580px';
    }
}
window.setInterval(catwalk6, 40);